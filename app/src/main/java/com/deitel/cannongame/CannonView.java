...
public class CannonView extends SurfaceView
        implements SurfaceHolder.Callback
 {
     ...
     //variables for the blocker target
     ...
     //variables for the cannon the cannonball
     ...
     public CannonView(Context context, AttributeSet attrs)
     {
         ...
         //construct Paints for drawingtext, cannonball, cannon,
         //blocker and target; these are configured in method in method onSizeChanged
         textPaint = new Paint(); //Paint for dawing text
     ...
     protected void onSizeChanged(int w, int h, int oldw, int oldh) {
         ...
         target.start=new Point(targetDistance,targetBeginning);target.end=new Point(targetDistance,targetEnd);
         ...
         if (cannonballOnScreen) {
             ...
             if (cannonball.x + cannonballRadius > blockerDistance &&
                 ...
                 soundPool.play(soundMap.get(BLOCKER_SOUND_ID), 1, 1, 1, 0, 1f);
                     ...
                     cannonball.x - cannonballRadius < 0) { //LR walls
                 cannonballOnScreen = false;
             } else if (cannonball.y + cannonballRadius > screenHeight ||
                     cannonball.y - cannonballRadius < 0) { //TB walls
                 cannonballOnScreen = false;
                     ...
                     cannonball.y - cannonballRadius < target.end.y) { //target
